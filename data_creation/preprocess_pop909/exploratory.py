...
if __name__ == '__main__':
    ...
    for pdir in pieces_dir:
        ...
        # print (sum(midi_beats_minor), len(midi_beats_major))
        # print (midi_beats_minor)
        # print (midi_beats_major)
        # print ('')
        ...
        if max(audio_beats) == 4.:
            ...
            try:
                ...
                qualified_triple += 1
                qualified_triple_pieces.append(pdir)
            except:
    ...
    pickle.dump(
        qualified_triple_pieces, 
        open('qual_triple_pieces.pkl', 'wb'), 
        protocol=pickle.HIGHEST_PROTOCOL
    )
